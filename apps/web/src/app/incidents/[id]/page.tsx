...
function IncidentErrorState({ id, message }: { id: string; message: string }) {
  return (
    <div className="ops-shell ops-safe-bottom min-h-[100dvh] px-4 py-5 text-slate-50 sm:px-6 lg:px-8">
      <div className="mx-auto flex min-h-[calc(100dvh-2.5rem)] max-w-7xl items-center">
        <div className="ops-card w-full rounded-[2rem] border border-rose-500/20 p-6 shadow-2xl shadow-black/30 sm:p-8">
